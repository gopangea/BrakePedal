...
Target Framework: `.NET 4.5 and above` because the main package contains an in-memory repository implementation based on `System.Runtime.Caching.ObjectCache` which is not compliant with PCL.
